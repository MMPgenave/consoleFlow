  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close
        className="dark:data-[state=open]:bg-slate-800! border-none!
      absolute left-6 top-6 rounded-sm opacity-70 ring-offset-white transition-opacity 
      hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-slate-950 
